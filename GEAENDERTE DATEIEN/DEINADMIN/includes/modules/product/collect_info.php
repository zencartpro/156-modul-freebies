 ...
 * @version $Id: collect_info.php for Free Gifts 2019-07-21 14:06:50Z webchills $
 */
...
if (isset($_GET['pID']) && empty($_POST)) {
 $product = $db->Execute("SELECT pd.products_name, pd.products_merkmale, pd.products_description, pd.products_url,
                                      ...
                                      products_date_available, p.products_status, p.products_carrot, p.products_tax_class_id,
                                      p.manufacturers_id,
...
// hidden fields not changeable on products page
  ...
  <div class="form-group"> 	
  	 <?php echo zen_draw_label(TEXT_PRODUCTS_CARROT, 'products_carrot', 'class="col-sm-3 control-label"'); ?>
  	<div class="col-sm-9 col-md-6">
      <?php echo zen_draw_checkbox_field('products_carrot', '', $pInfo->products_carrot); ?>
    </div>
  </div>
  <div class="form-group">
