...
// Copy attributes to duplicate product
  ...
  if ($_POST['copy_as'] == 'link') {
    ...
    $product = $db->Execute("SELECT products_type, products_carrot, products_quantity, products_model, products_image,
    ...
    $db->Execute("INSERT INTO " . TABLE_PRODUCTS . " (products_type, products_quantity, products_model, products_image,
                                                      ...
                                                      products_weight, products_status, products_carrot, products_tax_class_id,
