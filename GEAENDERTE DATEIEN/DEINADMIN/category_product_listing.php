 ...
 * @version $Id: category_product_listing.php for Free Gifts 2020-07-24 17:04:16Z webchills $
 */
...
// fix duplicates and force search to use master_categories_id
                /*
                  ...
                  $order_by);
                 */
                $products_query_raw = ("SELECT p.products_type, p.products_carrot, p.products_id, pd.products_name, p.products_quantity, p.products_image, p.products_price,
...
// Get categories_id for product if search
                ...
                <tr>
                  ...
                  <td class="hidden-sm hidden-xs"><?php echo $product['products_model']; ?><?php
