 ...
 * @version $Id: main_template_vars.php for Free Gifts 2019-07-21 14:47:36Z webchills $
 */
/*
 ...
 */
  ...
  $sql = "select count(*) as total
          ...
          where (p.products_status = '1' or p.products_carrot = '1')
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_carrot, p.products_id, pd.products_name,
